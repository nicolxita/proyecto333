...
html = re.sub(r'const comunasPorRegion = \{.*?\n\};', new_js_object, html, flags=re.DOTALL)

with open("index.html", "w", encoding="utf-8") as f:
    f.write(html)

print("Regions restored and new ones added successfully")
