...
async def scrape_tiktok_creative_center() -> List[ProductCandidate]:
    ...
    products = [
        ProductCandidate(
            ...
            supplier_url="https://www.aliexpress.com/item/1005004892341567.html",
            cost=12.99,
            suggested_price=49.99,
            monthly_searches=45000,
            aliexpress_orders=8500,
            rating=4.7,
            reviews_count=3200,
            facebook_ads_count=23,
        ...
        ProductCandidate(
            ...
            supplier_url="https://www.aliexpress.com/item/1005003847291234.html",
            cost=8.50,
            suggested_price=34.99,
            monthly_searches=38000,
            aliexpress_orders=12000,
            rating=4.8,
            reviews_count=5600,
            facebook_ads_count=18,
            tiktok_views=1800000,
            trend_growth_pct=65.0,
            trend_direction="rising",
            shipping_days=10,
            weight_kg=0.5,
            niche="home_decor",
